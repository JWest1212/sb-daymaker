...
import { TIER_WORD_PLURAL } from "../../ui/vocab";
...
export function CoverageView({
  ...
  return (
    <div className="wrap" style={{ display: "block", maxWidth: 1180 }}>
      ...
      <p className="vsub">Published {TIER_WORD_PLURAL[1]} + {TIER_WORD_PLURAL[2]} occurrences per window, cumulative from today. Click a cell to see what&apos;s in it.</p>
            ...
            <div className="dirlist">
              {directives.length === 0 ? (
                ...
                <div className="dirrow" key={d.id}>
                  ...
                  {d.runsUrl ? <a className="ps" href={d.runsUrl} target="_blank" rel="noreferrer">view runs &#8599;</a> : null}
                </div>
              ))}
            </div>
          </div>
