...
// which run to 14 characters and would overflow). `SB` is the last-resort floor —
// always renderable, never blank.
...
/** Fits the big word into the 100-unit viewBox without overflow/clipping —
 *  `nearby_zone` values ("waterfront") run longer than a 3-letter day abbreviation
