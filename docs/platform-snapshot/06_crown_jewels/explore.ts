/* ============================================================================
 * CROWN JEWEL — verbatim copy of lib/explore.ts
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: The cascade feed assembly + ranking layer for Explore. Builds the 
 * three-tier happenings cascade (Tier 1 dated -> Tier 2 recurring -> Tier 3 
 * evergreen) and orders each tier. AUDIT FOCUS: confirm the ranker never 
 * reads sponsor status / is_featured (Constraint 8, the trust rule), and that 
 * it is fully deterministic (Constraint 3, no per-request AI).
 * ==========================================================================*/
