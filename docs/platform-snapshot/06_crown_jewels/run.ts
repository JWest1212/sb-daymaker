/* ============================================================================
 * CROWN JEWEL — verbatim copy of ingest/run.ts
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: The nightly ingestion orchestrator (invoked by the GitHub Action 
 * nightly at 09:00 UTC via 'npx tsx ingest/run.ts'). Runs adapters -> dedupe 
 * -> land -> enrich (Claude) -> images -> digest. AUDIT FOCUS: step order, 
 * model IDs, timeout/retry/fallback, partial-failure behavior.
 * ==========================================================================*/
