/* ============================================================================
 * CROWN JEWEL — verbatim copy of ingest/images.ts
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: The image resolver waterfall (adapter-provided -> free sources -> 
 * Google Places -> placeholder). AUDIT FOCUS: waterfall order, caching, and 
 * the Google Places cost cap (Constraint 2).
 * ==========================================================================*/
