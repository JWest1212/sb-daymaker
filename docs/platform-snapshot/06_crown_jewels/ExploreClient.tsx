/* ============================================================================
 * CROWN JEWEL — verbatim copy of components/explore/ExploreClient.tsx
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: The Explore page client shell -- holds horizon/lens/zone filter state 
 * and composes Hero + ControlRow + CascadeFeed.
 * ==========================================================================*/
