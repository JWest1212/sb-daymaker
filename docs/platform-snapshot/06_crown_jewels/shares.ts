/* ============================================================================
 * CROWN JEWEL — verbatim copy of lib/shares.ts
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: The view-only share-link handler. Persists a saved-list/plan snapshot 
 * to shared_states and resolves it for /s/[token] and /p/[token]. AUDIT 
 * FOCUS: no recipient PII stored (Constraint 4).
 * ==========================================================================*/
