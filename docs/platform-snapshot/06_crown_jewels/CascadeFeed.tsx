/* ============================================================================
 * CROWN JEWEL — verbatim copy of components/explore/CascadeFeed.tsx
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: Renders the three-tier cascade UI (list / day-rail / rock-grid by 
 * horizon) plus the collapsible Tier 2/3 sections and the Build-your-day CTA.
 * ==========================================================================*/
