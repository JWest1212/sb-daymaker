/* ============================================================================
 * CROWN JEWEL — verbatim copy of lib/things.ts
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: The core Supabase query layer for happenings ('things'). Central read 
 * path shared by Explore, Discover, Plan, and share pages.
 * ==========================================================================*/
