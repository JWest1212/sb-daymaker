/* ============================================================================
 * CROWN JEWEL — verbatim copy of app/api/review/approve/route.ts
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: The single write path to thing_status='published' (overlay / 
 * single-edit / bulk modes) with server-side negative-tag enforcement. The 
 * cockpit's core mutation endpoint.
 * ==========================================================================*/
