/* ============================================================================
 * CROWN JEWEL — verbatim copy of components/saves/SavesProvider.tsx
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: The save/been client module. Sole owner of 
 * localStorage['sbd.saves.v1'] (map of thingId -> 'want'|'been'). No accounts 
 * (Constraint 4). AUDIT FOCUS: the want->been marking regression traced in 05.
 * ==========================================================================*/
