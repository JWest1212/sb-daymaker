/* ============================================================================
 * CROWN JEWEL — verbatim copy of components/ui/Card.tsx
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: The primary happening card primitive (list card / pick card) reused 
 * across Explore, Saved, Discover, and Plan.
 * ==========================================================================*/
