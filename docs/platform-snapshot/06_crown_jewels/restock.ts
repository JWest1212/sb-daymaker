/* ============================================================================
 * CROWN JEWEL — verbatim copy of ingest/restock.ts
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: The cockpit 'restock directives' logic -- computes coverage gaps that 
 * tell the operator what to refill. Backs the Coverage/restock cockpit 
 * surface.
 * ==========================================================================*/
