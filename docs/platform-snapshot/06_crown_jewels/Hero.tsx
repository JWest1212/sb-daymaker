/* ============================================================================
 * CROWN JEWEL — verbatim copy of components/explore/Hero.tsx
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: The signature golden-hour hero component (tracking sun, skyline SVG, 
 * condition chips, hero pick card).
 * ==========================================================================*/
