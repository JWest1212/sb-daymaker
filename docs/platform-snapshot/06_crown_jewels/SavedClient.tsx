/* ============================================================================
 * CROWN JEWEL — verbatim copy of components/saved/SavedClient.tsx
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: The Saved surface client. Owns the want/been view, the C2 'Did you 
 * make it?' prompt, grouping, share, and restore. AUDIT FOCUS: the 
 * been-marking REGRESSION at lines ~84-89 -- Saved-view memos derive from 
 * save VALUES but depend only on save KEYS with exhaustive-deps disabled, so 
 * a want->been flip never invalidates the memo (item stays stuck under 'Want 
 * to go').
 * ==========================================================================*/
