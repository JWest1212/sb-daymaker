/* ============================================================================
 * CROWN JEWEL — verbatim copy of ingest/dedupe.ts
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: Cross-source dedupe logic that collapses the same happening ingested 
 * from multiple adapters before landing.
 * ==========================================================================*/
