/* ============================================================================
 * CROWN JEWEL — verbatim copy of lib/heroServer.ts
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: Chooses the daily golden-hour hero pick server-side. Must never 
 * render blank -- falls back to a hand-written evergreen card (Constraint 5). 
 * AUDIT FOCUS: fallback path + whether hero selection can see sponsor status.
 * ==========================================================================*/
