/* ============================================================================
 * CROWN JEWEL — verbatim copy of lib/review.ts
 * (SB Daymaker platform snapshot @ caa7302, 2026-07-03. Read-only copy.)
 *
 * ROLE: Cockpit review-queue logic (approve/reject/update, trust chips, image 
 * picker) backing /admin/review and the /api/review/* routes.
 * ==========================================================================*/
